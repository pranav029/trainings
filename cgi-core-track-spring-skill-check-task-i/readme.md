...
#### Please follow these steps
        ...
        3. Navigate to cgi-pob-java-skill-check-task-i folder

            `cd cgi-core-track-spring-skill-check-task-i`

        4. Create a Springboot project inside  'cgi-core-track-spring-skill-check-task-i' folder and 
